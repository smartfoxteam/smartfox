...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fox features */
        {"fox", "masternode", &masternode, true, true, false},
        {"fox", "listmasternodes", &listmasternodes, true, true, false},
        {"fox", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fox", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fox", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fox", "masternodedebug", &masternodedebug, true, true, false},
        {"fox", "startmasternode", &startmasternode, true, true, false},
        {"fox", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fox", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fox", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fox", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fox", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fox", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fox", "mnbudget", &mnbudget, true, true, false},
        {"fox", "preparebudget", &preparebudget, true, true, false},
        {"fox", "submitbudget", &submitbudget, true, true, false},
        {"fox", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fox", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fox", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fox", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fox", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fox", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fox", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fox", "checkbudgets", &checkbudgets, true, true, false},
        {"fox", "mnsync", &mnsync, true, true, false},
        {"fox", "spork", &spork, true, true, false},
        {"fox", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fox", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use foxd, or the -server option to fox-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fox-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:40424/\n";
}
