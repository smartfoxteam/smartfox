...
#if defined(NDEBUG)
#error "FOX cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        nSubsidy = 226000 * COIN;
    } else if (nHeight < Params().LAST_POW_BLOCK()  && nHeight > 0) {
		nSubsidy = 1 * COIN;
    } else if (nHeight < 17280 && nHeight >= Params().LAST_POW_BLOCK()) {
        nSubsidy = 1 * COIN;
    } else if (nHeight < 30240  && nHeight >= 17280) {
        nSubsidy = 2 * COIN;
    } else if (nHeight < 38880 && nHeight >= 30240) {
        nSubsidy = 4 * COIN;
    } else if (nHeight < 47520 && nHeight >= 38880) {
        nSubsidy = 6 * COIN;
    } else if (nHeight < 56160 && nHeight >= 47520) {
        nSubsidy = 8 * COIN;
    } else if (nHeight < 108000 && nHeight >= 56160) {
        nSubsidy = 10 * COIN;
    } else if (nHeight < 118800  && nHeight >= 108000) {
        nSubsidy = 9 * COIN;
    } else if (nHeight < 129600  && nHeight >= 118800) {
        nSubsidy = 8 * COIN;
    } else if (nHeight < 140400 && nHeight >= 129600) {
        nSubsidy = 7 * COIN;
    } else if (nHeight < 151200  && nHeight >= 140400) {
        nSubsidy = 6 * COIN;
    } else if (nHeight < 162000  && nHeight >= 151200) {
        nSubsidy = 5 * COIN;
    } else if (nHeight < 788400  && nHeight >= 162000) {
        nSubsidy = 5 * COIN;
    } else if ( nHeight >= 788400) {
        nSubsidy = 5 * COIN;
		for (int i=0; i<nHeight/788400; i++) {
			nSubsidy=nSubsidy-(nSubsidy*20)/100;
		}	
    } else {
        nSubsidy = 0 * COIN;
    }
