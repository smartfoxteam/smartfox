...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case FOX:
            return QString("tFOX");
        case mFOX:
            return QString("mtFOX");
        case uFOX:
            return QString::fromUtf8("μtFOX");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case FOX:
            return QString("FOX");
        case mFOX:
            return QString("Milli-FOX (1 / 1" THIN_SP_UTF8 "000)");
        case uFOX:
            return QString("Micro-FOX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case FOX:
            return QString("TestFOXs");
        case mFOX:
            return QString("Milli-TestFOX (1 / 1" THIN_SP_UTF8 "000)");
        case uFOX:
            return QString("Micro-TestFOX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
