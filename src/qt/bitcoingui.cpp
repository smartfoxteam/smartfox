                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FOX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FOX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fox: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FOX Core"), this);
    aboutAction->setStatusTip(tr("Show information about FOX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FOX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FOX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FOX addresses"));
    ...
    openAction->setStatusTip(tr("Open a FOX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FOX Core help message to get a list with possible FOX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FOX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FOX network", "", count));
}
...
{
    QString strTitle = tr("FOX Core"); // default title
