...
RESOURCES += src/qt/fox.qrc src/qt/fox_locale.qrc

TRANSLATIONS += src/qt/locale/fox_bg.ts \
                src/qt/locale/fox_de.ts \
                src/qt/locale/fox_en.ts \
                src/qt/locale/fox_es.ts \
                src/qt/locale/fox_fi.ts \
                src/qt/locale/fox_fr.ts \
                src/qt/locale/fox_it.ts \
                src/qt/locale/fox_ja.ts \
                src/qt/locale/fox_pl.ts \
                src/qt/locale/fox_pt.ts \
                src/qt/locale/fox_ru.ts \
                src/qt/locale/fox_sk.ts \
                src/qt/locale/fox_sv.ts \
                src/qt/locale/fox_vi.ts \
                src/qt/locale/fox_zh_CN.ts \
                src/qt/locale/fox_zh_TW.ts
