Contributing to FOX Core
============================

The FOX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FOX Core project, and is not to be
confused with overall FOX Network Protocol consensus changes.

Whether a pull request is merged into FOX Core rests with the project merge
...
Patches that change FOX consensus rules are considerably more involved than
...
Where a patch set proposes to change the FOX consensus, it must have been
...
The project leader is the release manager for each FOX Core release.
