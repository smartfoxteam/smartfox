...
In order to support loading of multiple wallets in fox-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fox.cpp.
...
Changes to fox.cpp
----------------------
fox.cpp is the entry point into fox-qt, and as such, will require some minor modifications to provide hooks for
