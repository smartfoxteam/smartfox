...
Fox now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fox_address\> \<monthly_payment_fox\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ FOX, _12_ times over the course of a year totaling _24000_ FOX.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fox_address\> \<monthly_payment_fox\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` FOX.
